...
def test_checkpoint_files_exists(run_training, project_path):
    ...
    found_items = np.array(sorted(list(os.listdir(os.path.join(project_path, "checkpoints")))))
...
def test_model_files_exists(run_training, project_path):
    ...
    found_items = np.array(sorted(list(os.listdir(os.path.join(project_path, "models")))))
    expected_items = np.array(
        [
